        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <span className="text-xs text-purple-400 font-medium">Live Swarm Mesh Active</span>
            </div>
          </div>
          
          <button
            onClick={() => setShowDashboard(false)}
            className="flex items-center space-x-2 text-sm font-semibold bg-gray-700/60 hover:bg-purple-600 hover:text-white px-4 py-2 rounded-xl transition duration-200 border border-gray-600 cursor-pointer"
          >
            <ArrowLeft size={16} />
