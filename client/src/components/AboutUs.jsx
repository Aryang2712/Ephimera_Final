    ...
    <div className="about-page-root">
      ...
      <div className="about-container">
        ...
        <header className="about-nav">
          <button className="about-logo-btn" onClick={onBackToLanding} aria-label="Ephimera Home">
            <svg className="ephimera-brand-logo" viewBox="0 0 1260 280" height="26" fill="currentColor" style={{ color: '#121212' }}>
              <g fill="#121212">
