...
import { Activity, Server, Radio, Zap, HardDrive, Wifi, Copy, Check, RefreshCw, X, ShieldCheck } from 'lucide-react';
import VideoPlayer from './VideoPlayer';
import DropZone from './DropZone';

const DEMO_HLS_URL = "https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8";

// Live Typing Effect Hook with Smooth Cursor
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className={`px-4 py-2 rounded-full font-semibold text-xs sm:text-sm flex items-center gap-2.5 self-start sm:self-auto backdrop-blur-xl border transition-all duration-300 ${
          isConnected 
            ? 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30 shadow-[0_0_20px_rgba(16,185,129,0.2)]' 
            : 'bg-purple-500/15 text-purple-300 border-purple-500/30 shadow-[0_0_20px_rgba(168,85,247,0.15)]'
        }`}>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-[#16121f]/85 border border-purple-500/25 p-5 sm:p-6 shadow-2xl shadow-black/50 backdrop-blur-2xl">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-5 relative z-10">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-600/30 to-indigo-600/20 border border-purple-500/40 flex items-center justify-center text-purple-300 shrink-0 shadow-[0_0_18px_rgba(168,85,247,0.25)]">
              <Wifi size={22} />
            </div>
            <div>
              ...
              <p className="text-xs text-[#d8b4fe]/80 mt-1">Open this link on your 2nd laptop to render the live stream:</p>
            </div>
          </div>

          <div className="flex items-center gap-2.5 w-full md:w-auto">
            <div className="bg-[#0b090f]/90 text-gray-200 font-mono text-xs px-4 py-2.5 rounded-xl border border-purple-500/20 truncate flex-1 md:w-72 shadow-inner">
              {shareUrl || 'http://localhost:5173'}
            </div>
            <button
              onClick={handleCopyLink}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white transition-all duration-200 shrink-0 shadow-[0_0_20px_rgba(168,85,247,0.35)] hover:shadow-[0_0_25px_rgba(168,85,247,0.5)] cursor-pointer active:scale-95"
            >
      ...
      {/* Network Stats Cards - Color Graded to Landing Page Theme */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        
        {/* Card 1: Theme #B39CD0 (Lavender Lilac) */}
        <div className="relative overflow-hidden rounded-2xl bg-[#16121f]/80 p-5 border border-purple-500/20 shadow-xl shadow-black/40 backdrop-blur-xl flex flex-col items-center group hover:border-purple-400/40 hover:-translate-y-1 transition-all duration-300">
          <div className="absolute inset-x-4 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#B39CD0]/40 to-transparent" />
          <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-400/20 flex items-center justify-center text-[#B39CD0] mb-3 shadow-[0_0_12px_rgba(179,156,208,0.2)]">
            <Server size={20} />
          </div>
          ...
          <p className="text-[11px] text-[#B39CD0]/70 mt-1 font-mono">CDN Standby</p>
        </div>
        
        {/* Card 2: Theme #A855F7 (Electric Violet) */}
        <div className="relative overflow-hidden rounded-2xl bg-[#16121f]/80 p-5 border border-purple-500/20 shadow-xl shadow-black/40 backdrop-blur-xl flex flex-col items-center group hover:border-purple-400/40 hover:-translate-y-1 transition-all duration-300">
          <div className="absolute inset-x-4 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#A855F7]/40 to-transparent" />
          <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-400/20 flex items-center justify-center text-[#A855F7] mb-3 shadow-[0_0_12px_rgba(168,85,247,0.25)]">
            <Radio size={20} />
          </div>
          ...
          <p className="text-[11px] text-[#A855F7]/70 mt-1 font-mono">Real-Time RTP</p>
        </div>

        {/* Card 3: Theme #b38FB9 (Rose Mauve) */}
        <div className="relative overflow-hidden rounded-2xl bg-[#16121f]/80 p-5 border border-purple-500/20 shadow-xl shadow-black/40 backdrop-blur-xl flex flex-col items-center group hover:border-purple-400/40 hover:-translate-y-1 transition-all duration-300">
          <div className="absolute inset-x-4 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#b38FB9]/40 to-transparent" />
          <div className="w-10 h-10 rounded-xl bg-pink-500/10 border border-pink-400/20 flex items-center justify-center text-[#b38FB9] mb-3 shadow-[0_0_12px_rgba(179,143,185,0.25)]">
            <Zap size={20} />
          </div>
          ...
          <p className="text-[11px] text-[#b38FB9]/70 mt-1 font-mono">Sub-100ms Latency</p>
        </div>

        {/* Card 4: Theme #34d399 (Emerald Green) */}
        <div className="relative overflow-hidden rounded-2xl bg-[#16121f]/80 p-5 border border-purple-500/20 shadow-xl shadow-black/40 backdrop-blur-xl flex flex-col items-center group hover:border-purple-400/40 hover:-translate-y-1 transition-all duration-300">
          <div className="absolute inset-x-4 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#34d399]/40 to-transparent" />
          <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-400/20 flex items-center justify-center text-[#34d399] mb-3 shadow-[0_0_12px_rgba(52,211,153,0.25)]">
            <HardDrive size={20} />
          </div>
          ...
          <p className="text-[11px] text-[#34d399]/70 mt-1 font-mono">Direct P2P Offload</p>
        </div>
      ...
      {activeSource && !showDropZone && (
        <div className="relative overflow-hidden rounded-2xl bg-[#16121f]/90 border border-purple-500/30 p-4 shadow-xl backdrop-blur-xl flex flex-wrap items-center justify-between gap-3">
            ...
            <div>
              <div className="flex items-center gap-2.5">
                ...
                <span className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider ${
                  isP2P 
                    ? 'bg-purple-500/20 text-purple-300 border border-purple-500/35 shadow-[0_0_10px_rgba(168,85,247,0.2)]' 
                    : 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/35 shadow-[0_0_10px_rgba(16,185,129,0.2)]'
                }`}>
                  {roleLabel}
                </span>
              </div>
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-purple-950/40 border border-purple-500/30 bg-[#0c0912] min-h-[380px] flex items-center justify-center">
        {/* Glow ambient accent behind player */}
        <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/10 via-indigo-600/10 to-violet-600/10 blur-xl pointer-events-none -z-10" />
